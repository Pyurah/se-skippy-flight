...
- **Recent (0.15.x → 0.17.0):** in-world version header (0.15.0); connector powered on before the
  ...
  **0.18.1 fixes an ETA that read ~10× high** — the segment-walking estimate mis-timed straights at
