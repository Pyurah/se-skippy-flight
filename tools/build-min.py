#!/usr/bin/env python
"""
build-min.py - produce a comment-stripped SkippyFlight.min.cs for pasting into
the Programmable Block.

Space Engineers caps a PB script at 100,000 source characters, counting comments
and whitespace. SkippyFlight.cs is kept fully commented as the source of truth;
...
Writes SkippyFlight.min.cs next to SkippyFlight.cs and prints a size report.
...
def main():
    ...
    src_path = os.path.join(root, "SkippyFlight.cs")
    out_path = os.path.join(root, "SkippyFlight.min.cs")
